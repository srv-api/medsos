...
func (r *RoleUserPermissionRepository) Get(req dto.RoleUserPermissionRequest) (dto.GetRoleUserPermissionResponse, error) {
	var roles []dto.RoleUserPermissionResponse

	// Query untuk memvalidasi RoleUserPermission dan Role
	...
	if err != nil {
		return dto.GetRoleUserPermissionResponse{}, err
	}

	// Bungkus izin dalam field 'items' seperti yang diharapkan
	return dto.GetRoleUserPermissionResponse{
		Items: roles,
	}, nil
}
