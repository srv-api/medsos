...
func (r *RoleUserPermissionRepository) Pagination(req *dto.Pagination) (RepositoryResult, int) {
	var roleuserpermissions []entity.RoleUserPermission
	...
	find = find.Find(&roleuserpermissions)
